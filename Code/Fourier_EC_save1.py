...
This is a save of Fourier EC on January 15th, 2025. This version has a problem where I compute power differently for the restriction (filter_power) and to compute information.
In the former, I use the continuous formula (which is correct), but in the later case I use the discrete formula for P. This leads to a problem where I underestimate the power at high 
spatial frequencies, because there are more "lattice points" at higher frequencies (as you move away from origin). 
"""
